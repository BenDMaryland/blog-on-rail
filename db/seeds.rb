...
blog1= Blog.create(blog_title: "I need a .map()", image_url: "https://www.gsma.com/newsroom/wp-content/uploads//cross-border-data-flows-ASEAN-APEC-cover-image-1.jpg", blog_post: %q[Welcome to my journey to being a software engineer!
    ...
    blog2= Blog.create(blog_title: "Troubleshooting or: How I Learned To Stop Worrying And Love The Errors", image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Have_you_tried_turning_it_off_and_on_again%3F.svg/1280px-Have_you_tried_turning_it_off_and_on_again%3F.svg.png", blog_post: "
...
Over 70% of develops spend one or more days a week troubleshooting code.
This is shocking to no one because as project increase in scale so will the bugs!    
...
⚫ Take breaks: If you're stuck take a break, come back again. On a tight deadline? Work on something else for a bit. 
⚫ Take a step back, when you get tunnel vison.
⚫ patience Troubleshooting is a process.This can be hard when you're frustrated, but, it's the key to solving the problem.
