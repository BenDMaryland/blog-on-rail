...
blog1= Blog.create(blog_title: "I need a .map()", image_url: "https://www.gsma.com/newsroom/wp-content/uploads//cross-border-data-flows-ASEAN-APEC-cover-image-1.jpg", blog_post: %q[Welcome to my journey to being a software engineer!
    ...
    blog2= Blog.create(blog_title: "Troubleshooting or: How I Learned To Stop Worrying And Love The Errors", image_url: "https://www.gsma.com/newsroom/wp-content/uploads//cross-border-data-flows-ASEAN-APEC-cover-image-1.jpg", blog_post: "According to a poll of over 600 developers (https://resources.overops.com/wp-content/uploads/2020/05/Software_Quality_Survey_2020.pdf)
